        ...
        <div className='mt-5 pt-4 d-flex justify-content-center'>
            <form className='insert-form' onSubmit={SubmitEvent}>
                ...
                <div className="mb-3">
                    ...
                    <input type="date" className="form-control border-2" name="dob" id="dob" aria-describedby="emailHelp" required onChange={handleInput} style={{background:"none",borderColor:"black"}} />
                </div>
                <div className=" mb-3">
